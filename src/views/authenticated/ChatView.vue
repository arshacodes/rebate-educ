...
<template>
  <section class="w-1/3 bg-white rounded-lg shadow overflow-hidden flex flex-col md:w-full">
    ...
    <div class="flex-1 overflow-y-auto divide-y">
      ...
      <!-- Conversation item -->
      <div class="px-4 py-3 hover:bg-gray-100 cursor-pointer flex items-center w-full">
        <img
