...
<template>
    <aside class="hidden xl:flex xl:flex-col xl:w-72 border-l bg-white px-4 py-6 space-y-8">
        ...
        <div v-if="route.path != '/chat'" class="flex flex-col">
            <h3 class="text-lg font-semibold mb-4">Chats</h3>
            <div class="flex-auto overflow-y-auto space-y-3">
            ...
            <div class="mt-4 bg-gray-50 rounded-md flex flex-col h-64">
                <div
                    class="px-3 py-2 text-sm font-medium flex justify-between items-center"
                >
